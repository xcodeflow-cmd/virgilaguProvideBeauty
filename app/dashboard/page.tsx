        ...
        <div className="grid gap-0 xl:grid-cols-[1.02fr_0.98fr]">
          <div className="border-b border-white/10 p-8 sm:p-10 xl:border-b-0 xl:border-r xl:p-14">
            ...
            <div className="mt-10 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap">
              <Button asChild className="w-full px-4 sm:w-auto sm:px-7">
                <Link href="/live">Vezi LIVE</Link>
              </Button>
              <Button asChild variant="secondary" className="w-full px-4 sm:w-auto sm:px-7">
          ...
          <div className="grid gap-4 p-8 sm:grid-cols-2 sm:p-10 xl:p-14">
            <div className="rounded-[1.7rem] border border-white/10 bg-white/[0.03] p-5">
              ...
              <p className="mt-3 text-3xl text-white">Activ</p>
            </div>
            <div className="rounded-[1.7rem] border border-white/10 bg-white/[0.03] p-5">
        ...
        <div className="premium-card p-7 sm:p-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-4xl text-white">Cont activ</h2>
            </div>
